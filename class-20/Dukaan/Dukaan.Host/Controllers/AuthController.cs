...
public class AuthController(IAuthService authService, ITenantService tenantService) : ControllerBase
{
    /// <summary>
    ...
    CustomerLoginRequest request)
    {
        ...
        var response = await authService.LoginCustomerAsync(request, tenantId.Value);
